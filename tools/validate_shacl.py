...
def validate_with_shacl(
    data_graph: Graph, shapes_graph: Graph, verbose: bool = False
) -> Tuple[bool, str]:
    """
...
def main():
    ...
    shapes_file = (
        args.shapes if args.shapes.is_absolute() else gitroot / args.shapes
    )
    ...
    try:
        ...
        is_valid, report = validate_with_shacl(
            data_graph, shapes_graph, args.verbose
        )
